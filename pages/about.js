    ...
    <div className="max-w-6xl mx-auto px-6 py-16 text-gray-800">
      ...
      <section className="mb-16 flex flex-col md:flex-row items-center gap-8">
        <div className="md:w-1/2">
          ...
          <p>
            Founded in 2020, Shubh Avasar was born from a passion to celebrate Indian heritage through beautiful clothing.
            We combine traditional craftsmanship with modern style to bring you unique festive and everyday wear.
          </p>
        </div>
      ...
      <section className="mb-16 text-center">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 gap-4 mt-6">
          <Image src="/images/lehenga.jpg" alt="Lehenga" width={300} height={300} className="rounded-lg w-full h-auto object-cover" />
          <Image src="/images/kurta.jpg" alt="Kurta" width={300} height={300} className="rounded-lg w-full h-auto object-cover" />
          <Image src="/images/dress.jpg" alt="Dress" width={300} height={300} className="rounded-lg w-full h-auto object-cover" />
        </div>
      </section>
